...
def query_oracle_with_local_buffer(oracle, smiles_list, score_buffer, detail_buffer=None):
    """Local score buffer is independent from oracle.mol_buffer and Pareto buffer cleaning."""
...
## Fragment content:\n
        """
        self.smiles_score_clusters = pd.read_csv(settings.csv_path_url3, encoding='gbk')
        ...
        self.init_crossatt_path = settings.model_init_path_url3
        self.init_crossatt_path_pre = settings.model_init_predictor_path_url3
        self.add_crossatt_path = settings.model_add_path_url3
        self.add_crossatt_path_pre = settings.model_init_predictor_path_url3
