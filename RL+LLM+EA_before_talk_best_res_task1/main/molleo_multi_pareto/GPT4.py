...
class GPT4:
    def __init__(self):
        self.task2description_mul = {
            ...
            '3': '# Task:\nI have two molecules and their QED, SA (Synthetic Accessibility), JNK3 (biological activity against the kinase JNK3), GSK3$\beta$ (biological activity against Glycogen Synthase Kinase 3 Beta), DRD2 (biological activity against a biological target named the dopamine type 2 receptor (DRD2)) scores.\n',
        }
...
"""
    ...
    def edit(
        ...
        past_generation_total_temp = past_generation_total[:2]
        past_generation_total_temp_low = past_generation_total_low[:2]
