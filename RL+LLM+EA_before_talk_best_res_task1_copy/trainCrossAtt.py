...
if __name__ == "__main__":
    ...
    df = pd.read_csv('/home/yinan/Documents/fenzi/MOLLEO-main-server2/RL+LLM+EA_before_talk_best_res_task1/main/molleo_multi/datas_task1/selected_molecules_clustering.csv')
    ...
    torch.save(model.state_dict(), "/home/yinan/Documents/fenzi/MOLLEO-main-server2/RL+LLM+EA_before_talk_best_res_task1/main/molleo_multi/datas_task1/sgatt_init.pth")
    torch.save(predictor.state_dict(), "/home/yinan/Documents/fenzi/MOLLEO-main-server2/RL+LLM+EA_before_talk_best_res_task1/main/molleo_multi/datas_task1/predictor_init.pth")