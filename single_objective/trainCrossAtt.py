...
if __name__ == "__main__":
    ...
    df = pd.read_csv('/home/yinan/Documents/fenzi/MOLLEO-main-server2/RL+LLM+EA_before_talk_best_res_task3/main/molleo_multi/datas_task3/selected_molecules_clustering.csv')
    ...
    torch.save(model.state_dict(), "/home/yinan/Documents/fenzi/MOLLEO-main-server2/RL+LLM+EA_before_talk_best_res_task3/main/molleo_multi/datas_task3/sgatt_init.pth")
    torch.save(predictor.state_dict(), "/home/yinan/Documents/fenzi/MOLLEO-main-server2/RL+LLM+EA_before_talk_best_res_task3/main/molleo_multi/datas_task3/predictor_init.pth")